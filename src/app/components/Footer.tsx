      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="mb-4 bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-2xl font-bold text-transparent">
              Frensimuso
            </h3>
            <p className="mb-6 max-w-md text-gray-400">
              Full-stack developer passionate about creating innovative digital
              solutions. Specializing in modern web technologies, AI
        ...
        <div className="mt-8 flex flex-col items-center justify-between border-t border-gray-800 pt-8 md:flex-row">
          <p className="text-sm text-gray-400">
            © {currentYear} Frensimuso. All rights reserved.
          </p>

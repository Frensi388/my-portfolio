...
const getProjectMediaFiles = (project: Project): MediaFile[] => {
...
const ProjectSlide = (props: { project: Project }) => {
  const mediaFiles = getProjectMediaFiles(props.project);
            ...
            <div className="flex gap-2">
              ...
              {props.project.githubUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 rounded-lg bg-gray-900 px-3 py-2 text-center text-sm font-medium text-white transition-colors hover:bg-gray-800 dark:bg-gray-700 dark:hover:bg-gray-600"
                >
                  View Code
                </a>
              )}
